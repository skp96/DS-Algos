...
class Solution:
    ...
    def build_tree(self, preorder, inorder):
        # instead of having to scan inorder, we can use preorder element to lookup the respective index in inorder
    ...
    def build_tree_helper(self, preorder, inorder_dict, beg, end, preorder_idx):
        if beg > end return None  # instead of slicing array and having to check for a base case of empty array, we check if beg > end which would represent an empty array
        ...
        # instead of having to create a subarray of elements to the left and right of element, we pass in pointer values representing beg and end of subarrays
